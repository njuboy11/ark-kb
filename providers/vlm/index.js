...
export async function openaiVLM(provider, imageBase64, prompt, mimeType = "image/png") {
...
export async function anthropicVLM(provider, imageBase64, prompt, mimeType = "image/png") {
    const response = await fetch(provider.url, {
        method: "POST",
        headers: {
...
export async function minimaxVLM(provider, imageBase64, prompt, mimeType = "image/png") {
    const response = await fetch(provider.url, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${provider.apiKey}`,
